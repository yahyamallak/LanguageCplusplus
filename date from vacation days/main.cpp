...
Date dateFromVacationDays(Date dateFrom, short vacationDays) {
...
int main() { 
    ...
    date2 = dateFromVacationDays(date1, vacationDays);

    cout << "Return Date : " << DayShortName(DayOfWeekOrder(date2)) << " , " << date2.day << "/" << date2.month << "/" << date2.year << endl;
