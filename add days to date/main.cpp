...
Date addDaysToDate(short days, Date date) {

    short remainingDays = days + NumberOfDaysFromTheBeginningOfYear(date.day, date.month, date.year);
    short monthDays = 0;
...
int main() { 
    ...
    date = addDaysToDate(numberAdded, date);

    
    cout << "Date after adding [" << numberAdded << "] days is : " << date.day << "/" << date.month << "/" << date.year << endl;
