...
int CountNegativeNumsArray(int arr[100], int arrLength) {
    
    int counter = 0;
    
    for(int i = 0; i < arrLength; i++){
        if(CheckNumberSign(arr[i]) == enNumberSign::Negative) {
            counter++;
        }
    }
...
int main() {
    ...
    cout << "Negative Numbers count is : " << CountNegativeNumsArray(arr, arrLength);
